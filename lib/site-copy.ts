...
export const siteCopy = {
  ...
  am: {
    ...
    hero: {
      badge: 'ከ1960 ጀምሮ በኢትዮጵያ እያገለገልን',
      titleStart: 'ወንጌልን እናበስራለን።',
      titleHighlight: 'ደቀ መዛሙርትን እናፈራለን።',
      titleEnd: 'ጤናማ አብያተ ክርስቲያናትን እንተክላለን።',
      description:
        'አማኑኤል ባፕቲስት ቤተ ክርስቲያን በኢትዮጵያ ከ1960 ጀምሮ የሚያገለግል በወንጌል የተመሰረተ ባፕቲስት ማህበር ሲሆን ክርስቶስን ለማወጅ፣ እውነተኛ ደቀ መዛሙርትን ለማፍራት እና መጽሐፍ ቅዱሳዊ የአካባቢ አብያተ ክርስቲያናትን ለማጠናከርና ለመትከል የተሰጠ ነው።',
      stats: [
